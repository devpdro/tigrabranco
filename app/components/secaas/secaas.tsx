...
interface SecaasProps {
  onOpenContact?: () => void;
}

export function Secaas({ onOpenContact }: SecaasProps) {
        ...
        <div className={S.hero}>
          ...
          >
            ...
            <p className={S.subtitle}>
              ...
              infraestrutura completa de uma securitizadora já existente, sem
              precisar criar a sua própria. Você foca em originar crédito. Nós
              cuidamos de toda a estrutura por trás.
            </p>
